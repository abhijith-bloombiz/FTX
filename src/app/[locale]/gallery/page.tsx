                ...
                <div key={`${activeCategory}-${activeMediaType}-${layoutMode}`} className="animate-grid-reveal">
                    {layoutMode === "grid" ? (
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                                    ...
                                    >
                                        ...
                                        <div className="absolute top-6 right-6 flex items-center gap-2 z-10">
                                            {(filteredItems[0]?.isVideo || filteredItems[0]?.video) && (
                                                <span className="px-2.5 py-1 bg-ftx-lime text-ftx-black font-mono font-bold text-[10px] uppercase tracking-wider ftx-squircle-sm shadow-lime-glow flex items-center gap-1">
                                                    <Play className="w-3 h-3 fill-ftx-black" />
                                                    <span>{locale === "ar" ? "فيديو" : "VIDEO"}</span>
                                                </span>
                                            )}
                                        ...
                                        {(filteredItems[0]?.isVideo || filteredItems[0]?.video) && (
                                            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                                                <div className="w-16 h-16 rounded-full bg-ftx-lime/90 text-ftx-black flex items-center justify-center shadow-lime-glow group-hover:scale-110 transition-transform duration-300">
                                ...
                                <ScrollReveal type="horizontal" direction="right" delay={120} className="lg:col-span-4 flex flex-col h-full">
                                    ...
                                    >
                                        ...
                                        {(filteredItems[1]?.isVideo || filteredItems[1]?.video) && (
                                            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                                                <div className="w-14 h-14 rounded-full bg-ftx-lime/90 text-ftx-black flex items-center justify-center shadow-lime-glow group-hover:scale-110 transition-transform duration-300">
                            ...
                            {/* Bottom Row: 4 cols card + 8 cols Wide Split card */}
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                                {/* Bottom Left Card (3rd item) */}
                                <ScrollReveal type="horizontal" direction="left" delay={200} className="lg:col-span-4 flex flex-col h-full">
                                    ...
                                    >
                                        <Image
                                            ...
                                            alt={filteredItems[2]?.title[locale] || "McLaren 720S"}
                                            fill
                                            className="object-cover transition-transform duration-700 ease-out group-hover:scale-105"
                                        />
                                        <div className="absolute inset-0 bg-gradient-to-t from-ftx-black via-ftx-black/50 to-transparent" />
                                ...
                                {/* Bottom Right Wide Card: Paint Correction Split Showcase (4th item) */}
                                <ScrollReveal type="horizontal" direction="right" delay={280} className="lg:col-span-8 flex flex-col h-full">
                                    <div
                                        ...
                                        className="ftx-squircle-xl group cursor-pointer bg-ftx-surface relative overflow-hidden border border-ftx-surface-high hover:border-ftx-lime/40 min-h-[320px] sm:min-h-[380px] h-full grid grid-cols-1 sm:grid-cols-2 shadow-2xl transition-colors duration-300"
                                    >
                                        {/* Content Side */}
                                        <div className="p-8 sm:p-10 flex flex-col justify-between bg-ftx-surface/90 relative z-10 space-y-6">
                                            <div className="space-y-3">
                                                ...
                                                <p className="text-xs text-ftx-silver-muted font-body leading-relaxed max-w-sm line-clamp-3">
                                                    {filteredItems[3]?.description[locale]}
                                                </p>
                                            </div>

                                            <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-ftx-lime hover:text-ftx-lime-bright uppercase tracking-wider group/link">
                                        ...
                                        <div className="relative w-full h-full min-h-[220px]">
                                            <Image
                                                ...
                                                alt={filteredItems[3]?.title[locale] || "Process"}
                                                fill
                                                className="object-cover transition-transform duration-700 ease-out group-hover:scale-105"
                                            />
                                        ...
                                        return (
                                            ...
                                            >
                                                <div
                                                    ...
                                                    className="ftx-squircle-xl group cursor-pointer bg-ftx-surface relative overflow-hidden border border-ftx-surface-high hover:border-ftx-lime/40 min-h-[340px] h-full flex flex-col justify-between p-6 shadow-2xl transition-all duration-300"
                                                >
                                                    <Image
                                                        src={item.image}
                                                    ...
                                                    <div className="relative z-10 space-y-2 mt-auto pt-16">
                                                        ...
                                                        <p className="text-xs text-ftx-silver-muted font-body line-clamp-2 leading-relaxed">
