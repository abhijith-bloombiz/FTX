...
export function ServicesGrid({ locale, messages }: ServicesGridProps) {
    return (
        <section id="services" className="py-10 sm:py-12 bg-black relative overflow-hidden">
            ...
            <div className="hidden sm:block absolute -bottom-24 -right-24 w-[600px] h-[600px] bg-ftx-lime/15 blur-[130px] rounded-full pointer-events-none z-0" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
                    ...
                    >
                        <Link
                            ...
                            className="group relative overflow-hidden ftx-squircle-xl bg-[#131313] border border-white/10 min-h-[480px] sm:min-h-[520px] h-full flex flex-col justify-between p-6 sm:p-8 shadow-2xl transition-all duration-500 hover:border-ftx-lime/50"
                        >
                            ...
                            <div className="absolute inset-0 w-full h-full overflow-hidden z-0 bg-black">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-ftx-black via-ftx-black/75 to-ftx-black/30 z-10" />
                            </div>
                            ...
                            <div className="relative z-20 flex items-end justify-between gap-6 mt-auto">
                                ...
                                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full border border-ftx-lime flex items-center justify-center text-ftx-lime bg-ftx-black/60 backdrop-blur-md group-hover:bg-ftx-lime group-hover:text-ftx-black transition-all duration-300 shrink-0 shadow-lg mb-1">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6 h-full justify-between">
                        ...
                        >
                            <Link
                                ...
                                className="group relative overflow-hidden ftx-squircle-xl bg-[#131313] border border-white/10 min-h-[235px] sm:min-h-[245px] flex flex-col justify-between p-5 sm:p-6 shadow-2xl transition-all duration-500 hover:border-ftx-lime/50 h-full"
                            >
                                {/* Full-Bleed Background Image Container */}
                                <div className="absolute inset-0 w-full h-full overflow-hidden z-0 bg-black">
                                    <img
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-ftx-black via-ftx-black/75 to-ftx-black/20 z-10" />
                                </div>

                                {/* Top Header Overlay: Index Number (02) */}
                                <div className="relative z-20 flex items-center justify-end">
                                    <span className="text-2xl sm:text-3xl font-mono font-black text-white/50 group-hover:text-ftx-lime transition-colors drop-shadow-lg">
                                        02
                                    </span>
                                </div>
                                ...
                                <div className="relative z-20 flex items-end justify-between gap-4">
                                    ...
                                    <div className="w-10 h-10 rounded-full border border-ftx-lime flex items-center justify-center text-ftx-lime bg-ftx-black/60 backdrop-blur-md group-hover:bg-ftx-lime group-hover:text-ftx-black transition-all duration-300 shadow-lg shrink-0">
