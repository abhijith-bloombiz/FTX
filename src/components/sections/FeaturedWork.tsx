    ...
    return (
        <section id="ourwork" className="py-10 sm:py-12 bg-black relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* 3 Featured Cards Grid with Directional Entrance Animations */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {featuredItems.map((item, index) => {
                        const revealType = index === 0 ? "horizontal" : index === 1 ? "card" : "horizontal";
                        const revealDir = index === 0 ? "left" : index === 2 ? "right" : undefined;
