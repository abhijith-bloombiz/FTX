...
export function PackageCard({ packageData, locale, ctaText }: PackageCardProps) {
    ...
    return (
        <div className="relative h-full pt-3.5">
            ...
            {showBadge && (
                <div className="absolute top-0 ltr:right-6 rtl:left-6 z-30 px-3 py-1 bg-ftx-lime text-ftx-black text-[10px] font-mono font-bold tracking-widest uppercase ftx-btn-tech shadow-lime-glow">
                    {badgeText}
                </div>
            )}
