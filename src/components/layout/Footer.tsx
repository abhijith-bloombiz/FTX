...
import { ArrowUpRight, Phone, Mail, MapPin, Clock, Instagram, Youtube, Facebook } from "lucide-react";
...
export function Footer({ locale, messages }: FooterProps) {
    ...
    return (
        <footer className="relative bg-ftx-black text-ftx-silver border-t border-ftx-surface-high overflow-hidden">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <a
                                ...
                                className="p-2 text-ftx-silver hover:text-ftx-lime bg-ftx-surface border border-ftx-surface-high rounded transition-colors duration-200"
            ...
            {/* Bottom Copyright */}
            <div className="border-t border-ftx-surface-high/60 py-6 bg-ftx-obsidian">
